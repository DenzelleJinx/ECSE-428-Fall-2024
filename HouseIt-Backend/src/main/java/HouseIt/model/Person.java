...
public class Person
{
  ...
  public Person(int aId, String aFirstName, String aLastName, String aEmail, String aPhoneNumber, String aPassword, PersonRole aPersonRoles)
  {
    id = aId;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, id, lastName, password, phoneNumber, personRoles);
  }
}