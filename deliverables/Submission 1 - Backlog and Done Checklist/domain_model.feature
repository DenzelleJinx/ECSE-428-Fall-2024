Feature: Create the domain model
    As a developer, I want to update the domain model and see the changes being reflected in the code generation.

Scenario: Updating a class to add new attributes (Normal Flow)
...
Scenario: Updating a class to add new associations (Alternate Flow)
    Given the domain model exists
    And the class exists
    When the user chooses to modify the class
...
Scenario: Updating a class to add an enumeration (Alternate Flow)
    Given the domain model exists
    And the class exists
    When the user chooses to modify the class
...
Scenario: Creating a sub-class  (Alternate Flow)
    Given the domain model exists
...
Scenario: Create Invalid Domain Model Definitions (Error Flow: Invalid Domain Model)
    Given the domain model exists
    And the class exists
